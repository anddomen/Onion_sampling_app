...
server <- function(input, output) {
  ...
  observeEvent(input$run_sim, {
    ...
    if (any(c(input$scenario1.contam, input$scenario1.lot, 
              input$scenario1.sample) <= 0)) {
              # input$scenario2.contam, input$scenario2.lot, input$scenario2.sample
